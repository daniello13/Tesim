...
и <b>html</b> <i>тегами!</i>",
                ...
                Bot.OnUpdate += async (object su, Telegram.Bot.Args.UpdateEventArgs evu) =>
                {
                    ...
                    try
                    {
                        if (message.Type == Telegram.Bot.Types.Enums.MessageType.TextMessage)
                        {
                            ...
                            else if (message.Text == "Войти в первую дверь")
                            {
                                ...
                                await Bot.SendTextMessageAsync(message.Chat.Id, door12, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                string door13 = "- Братик?..  – <i>недоуменно переспросил я. \n\nНеужели эта девушка – моя сестра?</i>";
                                await Bot.SendTextMessageAsync(message.Chat.Id, door13, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                ...
                                await Bot.SendTextMessageAsync(message.Chat.Id, door14, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                ...
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_15, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                string door_16 = "- Прости, я совершенно ничего не помню. Не знаю, что произошло.";
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_16, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                ...
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_17, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                string door_18 = "-Мне очень жаль.";
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_18, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                ...
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_19, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_110, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_111, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_112, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_113, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_114, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_115, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_116, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_117, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_118, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_119, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_120, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_121, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_122, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_123, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_124, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_125, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_126, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_127, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_128, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_129, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_130, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_131, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_132, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_133, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_134, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_135, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_136, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_137, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_138, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_139, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_140, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_141, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_142, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_143, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_144, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_145, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_146, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_147, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_148, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_149, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_150, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_151, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_152, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_153, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_154, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_155, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_156, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_157, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_158, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_159, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_160, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_161, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_162, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_163, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_164, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_165, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_166, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_167, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_168, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_169, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_170, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_171, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_172, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_173, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_174, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_175, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_176, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_177, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_178, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_179, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_180, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_181, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_182, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_183, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_184, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_185, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_186, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_187, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_188, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_189, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_190, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_191, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_192, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_193, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_194, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_195, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_196, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_197, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_198, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_199, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1100, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1101, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1102, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1103, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1104, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1105, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1106, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1107, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1108, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1109, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1110, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1111, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                ...
                                Keys_to_file(message.Chat.Id, keys);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1112, false, false, 0, keyboard, ParseMode.Html); Thread.Sleep(13);
                            ...
                            else if (message.Text == "Заступиться за сестру")
                            {
                                ...
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1113, false, false, 0, keyboard, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1114, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1115, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1116, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1117, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1118, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1119, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1120, false, false, 0, keyboardDoor2, ParseMode.Html); Thread.Sleep(13);
                            ...
                            else if (message.Text == "Уйти")
                            {
                                ...
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1121, false, false, 0, keyboardDoor2, ParseMode.Html); Thread.Sleep(13);
                                string[] keys = { "Войти во вторую дверь", "/help" };
                                Keys_to_file(message.Chat.Id, keys);
                            }
                            else if (message.Text == "Поговорить")
                            {
                                ...
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1123, false, false, 0, keyboard, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1124, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1125, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1126, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1127, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1128, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1129, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1130, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1131, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1132, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1133, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1134, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1135, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1136, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1137, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_1138, false, false, 0, keyboardDoor2, ParseMode.Html); Thread.Sleep(13);
                                string[] keys = { "Войти во вторую дверь", "/help" };
                                Keys_to_file(message.Chat.Id, keys);
                            }
                            ...
                            else if (message.Text == "Войти во вторую дверь")
                            {
                                ...
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_20, false, false, 0, keyboardWait, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_21, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_22, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_23, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_24, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_25, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_26, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_27, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_28, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_29, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_210, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_211, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_212, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_213, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_214, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_215, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_216, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_217, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_218, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_219, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_220, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_221, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_222, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_223, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_224, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_225, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_226, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_227, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_228, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_229, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_230, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_231, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_232, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_233, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_234, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_235, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_236, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_237, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_238, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_239, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_240, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_241, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_242, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_243, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_244, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_245, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_246, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_247, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_248, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_249, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_250, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_251, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_252, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_253, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_254, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_255, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_256, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_257, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_258, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_259, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_260, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_261, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_262, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_263, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_264, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_265, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_266, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_267, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_268, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_269, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_270, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_271, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_272, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_273, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                var keyboard = new Telegram.Bot.Types.ReplyMarkups.ReplyKeyboardMarkup
                                {
                                    Keyboard = new[] {
                                                new[] // row 1
                                ...
                                Keys_to_file(message.Chat.Id, keys);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_274, false, false, 0, keyboard, ParseMode.Html); Thread.Sleep(13);
                            ...
                            else if (message.Text == "Остановить")
                            {
                                ...
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_276, false, false, 0, keyboardWait, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_277, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_278, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_279, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_280, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                string[] keys = { "Остановить", "/help" };
                                Keys_to_file(message.Chat.Id, keys);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_281, false, false, 0, keyboardDoor3, ParseMode.Html); Thread.Sleep(13);
                            ...
                            else if (message.Text == "Согласиться")
                            {
                                ...
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_282, false, false, 0, keyboardWait, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door
false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_512, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_513, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_514, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_515, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_516, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_517, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_518, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_519, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_520, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_521, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_522, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_523, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_524, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_525, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_526, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_527, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_528, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_529, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_530, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_531, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_532, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_533, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_534, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_535, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_536, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_537, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_538, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_539, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_540, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_541, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_542, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_543, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_544, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_545, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_546, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_547, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_548, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_549, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_550, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_551, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_552, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_553, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_554, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_555, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_556, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_557, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_558, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_559, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_560, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_561, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_562, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_563, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_564, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_565, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_566, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_567, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_568, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_569, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_570, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_571, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_572, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_573, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_574, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_575, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_576, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_577, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_578, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_579, false, false, 0, keyboardDoor6, ParseMode.Html); Thread.Sleep(13);
                            ...
                            else if (message.Text == "Войти в шестую дверь")
                            {
                                ...
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_60, false, false, 0, keyboardWait, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_61, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_62, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_63, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_64, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_65, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_66, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_67, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_68, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_69, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_610, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_611, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_612, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_613, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_614, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_615, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_616, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_617, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_618, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_619, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_620, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_621, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_622, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_623, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_624, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_625, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_626, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_627, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_628, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_629, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_630, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_631, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_632, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_633, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_634, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_635, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_636, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_637, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_638, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_639, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_640, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_641, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_642, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_643, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_644, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_645, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_646, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_647, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_648, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_649, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_650, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_651, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_652, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_653, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_654, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_655, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_656, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_657, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_658, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_659, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_660, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_661, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_662, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_663, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_664, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_665, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_666, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_667, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_668, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_669, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_670, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_671, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_672, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_673, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_674, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_675, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_676, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_677, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_678, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_679, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_680, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_681, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_682, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_683, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_684, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_685, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_686, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_687, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_688, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_689, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_690, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_691, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_692, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_693, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_694, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_695, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_696, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_697, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_698, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_699, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                //problem
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6710, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6711, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6712, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6713, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6714, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6715, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6716, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6717, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6718, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6719, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6810, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6811, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6812, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6813, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6814, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6815, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6816, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6817, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6818, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6819, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6910, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6911, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6912, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6913, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6914, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6915, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6916, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6917, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6918, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6919, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                //problem fixed
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6100, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6101, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6102, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6103, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6104, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6105, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6106, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6107, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6108, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6109, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6110, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6111, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6112, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6113, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6114, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6115, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6116, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6117, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6118, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6119, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6120, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6121, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6122, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6123, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6124, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6125, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6126, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6127, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6128, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6129, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6130, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6131, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6132, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                ...
                                Keys_to_file(message.Chat.Id, keys);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6133, false, false, 0, keyboard, ParseMode.Html); Thread.Sleep(13);
                            ...
                            else if (message.Text == "Перейти к эпилогу")
                            {
                                ...
                                Keys_to_file(message.Chat.Id, keys);
                                await Bot.SendTextMessageAsync(message.Chat.Id, epilog, false, false, 0, keyboardWait, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, end, false, false, 0, keyboard, ParseMode.Html); Thread.Sleep(13);
                            }
                            //дверь №6
                            else if (message.Text == "Остаться")
                            {
                                ...
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6135, false, false, 0, keyboardWait, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6136, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6137, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                            ...
                            else if (message.Text == "Вернуться к Алене")
                            {
                                ...
                                Keys_to_file(message.Chat.Id, keys);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6139, false, false, 0, keyboardWait, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6140, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6141, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6142, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6143, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6144, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6145, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6146, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                            ...
                            else if (message.Text == "Вернуться к Ирине")
                            {
                                ...
                                Keys_to_file(message.Chat.Id, keys);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6148, false, false, 0, keyboardWait, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6149, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6150, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6151, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6152, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6153, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6154, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6155, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                            ...
                            else if (message.Text == "Вернуться к Анне")
                            {
                                ...
                                Keys_to_file(message.Chat.Id, keys);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6157, false, false, 0, keyboardWait, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6158, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6159, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6160, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6161, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6162, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6163, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6164, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                            ...
                            else if (message.Text == "Вернуться к Жанне")
                            {
                                ...
                                Keys_to_file(message.Chat.Id, keys);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6166, false, false, 0, keyboardWait, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6167, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6168, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6169, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6170, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6171, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6172, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6173, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                            ...
                            else if (message.Text == "Отправиться за Юи")
                            {
                                ...
                                Keys_to_file(message.Chat.Id, keys);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6175, false, false, 0, keyboardWait, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6176, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6177, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6178, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6179, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6180, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6181, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6182, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6183, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6184, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6185, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6186, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6187, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6188, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6189, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6190, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                                await Bot.SendTextMessageAsync(message.Chat.Id, door_6191, false, false, 0, null, ParseMode.Html); Thread.Sleep(13);
                    ...
                    catch(Exception p)
                    {
                        ...
                        await Bot.SendTextMessageAsync(message.Chat.Id, "Внимание, произошла задержка загрузки игры. Для продолжения выберите вариант заново", false, false, 0, keyboard, ParseMode.Html); Thread.Sleep(13);
                    }
                };
